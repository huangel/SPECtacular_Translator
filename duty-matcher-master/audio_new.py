...
def listen_print_loop(responses, my_username, target, out):
    ...
    for response in responses:
        ...
        if not result.is_final:
            ...
            doc_ref = db.collection(u'translation').document(my_username) #TODO
...
def main(my_username, my_lang, other_username, other_lang):
    ...
    language_code =  my_lang  # a BCP-47 language tag
    ...
    with MicrophoneStream(RATE, CHUNK) as stream:
        ...
        listen_print_loop(responses, my_username, target, out)
